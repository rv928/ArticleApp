...
class AttributedLabel: UILabel {
    ...
    func setAttributedTextColor(leadingText:String?,trailingText:String?) {
        ...
        if leadingText != nil && trailingText != nil {
            ...
            let attributesForLeading = [NSAttributedString.Key.font:UIConstant.Fonts.FONT_HELVETICA_REGULAR(12.0),
            ...
            let attributesForTrailing = [NSAttributedString.Key.font:UIConstant.Fonts.FONT_HELVETICA_REGULAR(12.0),
